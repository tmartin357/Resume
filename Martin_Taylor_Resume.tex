...
\address{(470)~$\cdot$~338~$\cdot$~5115 \\ Powder Springs, GA 30127} % Your address
%\address{123 Pleasant Lane \\ City, State 12345} % Your secondary addess (optional)
\address{taylor.martin357@gmail.com} % Your phone number and email
...
Bachelor's of Science in Computer Science \hfill {\em Overall GPA: 3.59} \\%\smallskip \\
...
\item Provided quality control by inspecting each shade for defects %and checking for correct measurements
\end{rSubsection}
